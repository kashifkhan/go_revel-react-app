...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <div key={this.props.Id} className="post panel panel-default">
...
var PostBox = React.createClass({
  loadPostsFromServer: function() {
    $.ajax({
      url: "https://devbox-kashifkhan.c9users.io/posts",
      dataType: 'json',
      cache: false,
  ...
  handlePostSubmit: function(post) {
    ...
    var newUrl = this.props.url + "posts"
...
ReactDOM.render(
  <PostBox url="/" pollInterval={20000} />,
